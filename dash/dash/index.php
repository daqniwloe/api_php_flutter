        ...
        <tbody>
            ...
            while($row_usuario = mysqli_fetch_assoc($resultado_usuario)){
                ...
                <tr>
                    ...
                    <td>
                        <center>
                            <i> <a href="#""><span style="color: black" class="btn btn-danger btn-simple btn-xs">
                                ...
                                <i> 
                                <i> <a href="#"><span style="color: black" class="btn btn-danger btn-simple btn-xs"><i class="fa fa-eye"></i>
                                <i> <a href="#"><span style="color: red" class="btn btn-danger btn-simple btn-xs"><i class="fa fa-remove"></i>
                                </span>
                                </a>
                                </i></center>
                                </span>
